...
Use stable Skill release `v0.1.1` for portable installation. The full interactive plugin is currently `0.2.0-beta.5` and is not yet a stable marketplace release.
